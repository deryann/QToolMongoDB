...
class HDYQuestionParser:
    ...
    def getQuestionDicJson(self):
        dicJson = {}
        dicJson["FULLDOC"] = self.strBuffer
        dicJson["QBODY"] = self.strQBODY
        dicJson["QFROM"] = self.strQFROM
        dicJson["QANS"] = self.strQANS
        dicJson["QSOL"] =self.strQSOL
        dicJson["QSOL2"] =self.strQSOL2
        dicJson["QTAG"] = self.getListOfTag()
        return dicJson
